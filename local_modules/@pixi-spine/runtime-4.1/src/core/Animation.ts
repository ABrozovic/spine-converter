      ...
      case 0 /*LINEAR*/:
        ...
        return (
          ...
          ((time - before) / (frames[i + 2 /*ENTRIES*/] - before)) *
            (frames[i + 2 /*ENTRIES*/ + 1 /*VALUE*/] - value)
        );
      case 1 /*STEPPED*/:
    ...
    switch (curveType) {
      ...
      default:
        ...
        y = this.getBezierValue(
          ...
          i,
          2 /*VALUE2*/,
          curveType + 18 /*BEZIER_SIZE*/ - 2 /*BEZIER*/
        );
    }
    ...
    switch (curveType) {
      ...
      default:
        ...
        b = this.getBezierValue(
          ...
          i,
          3 /*B*/,
          curveType + 18 /*BEZIER_SIZE*/ * 2 - 2 /*BEZIER*/
        );
        a = this.getBezierValue(
          time,
          i,
          4 /*A*/,
          curveType + 18 /*BEZIER_SIZE*/ * 3 - 2 /*BEZIER*/
        );
    }
    ...
    switch (curveType) {
      ...
      default:
        ...
        r2 = this.getBezierValue(
          ...
          i,
          5 /*R2*/,
          curveType + 18 /*BEZIER_SIZE*/ * 4 - 2 /*BEZIER*/
        );
        g2 = this.getBezierValue(
          time,
          i,
          6 /*G2*/,
          curveType + 18 /*BEZIER_SIZE*/ * 5 - 2 /*BEZIER*/
        );
        b2 = this.getBezierValue(
          time,
          i,
          7 /*B2*/,
          curveType + 18 /*BEZIER_SIZE*/ * 6 - 2 /*BEZIER*/
        );
    }
...
export class IkConstraintTimeline extends CurveTimeline {
  ...
  apply(
    ...
    let constraint: IkConstraint =
      skeleton.ikConstraints[this.ikConstraintIndex];
...
export class PathConstraintPositionTimeline extends CurveTimeline1 {
  ...
  apply(
    ...
    let constraint: PathConstraint =
      skeleton.pathConstraints[this.pathConstraintIndex];
    if (!constraint.active) return;
